...
function Work() {
  return (
    <div className="content-headings">
      ...
      <p className="p">
        A curated selection of some of the projects I have worked on. A full collection of my work
        is available on GitHub. There, you can also find the links to the deployed applications.
        <br></br>
        Click on the title of the project to visit the deployed application and click on the gitHub
        icon to visit the repo.
      </p>
    </div>
  );
}
